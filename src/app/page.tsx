        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 md:py-24 lg:grid-cols-2 lg:items-center lg:px-8">
          <div>
            ...
            <div className="mt-10 flex gap-8">
              <div>
                <p className="font-display text-3xl text-plum">500+</p>
                <p className="text-xs uppercase tracking-wide text-charcoal/50">
                  Crowns delivered
                </p>
              </div>
              <div>
                <p className="font-display text-3xl text-plum">4.9&#9733;</p>
                <p className="text-xs uppercase tracking-wide text-charcoal/50">
                  Customer rating
                </p>
              </div>
              <div>
                <p className="font-display text-3xl text-plum">R1,500</p>
                <p className="text-xs uppercase tracking-wide text-charcoal/50">
                  Free delivery over
                </p>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mb-12 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 font-display text-4xl text-plum">Collections</h2>
          </div>
          <Link
            href="/collections"
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mb-12 flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 font-display text-4xl text-plum">Best Sellers</h2>
            </div>
            <Link
              href="/shop"
              className="text-sm font-semibold text-plum underline decoration-gold decoration-2 underline-offset-4 transition hover:text-rose"
